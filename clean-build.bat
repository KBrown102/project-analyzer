...
if "%CH%"=="1" (
  ...
  if exist "%P4%" del /f /q "%P4%" && echo     已删 %P4% || echo     未找到 %P4%
  echo.
...
if "%CH%"=="2" (
  ...
  if exist "%P4%" del /f /q "%P4%" && echo     已删 %P4%
